...
final class MapObjectVisitorImpl implements MapObjectVisitor {
  ...
  final bool Function(ClusterizedPlacemarkCollection) onClusterizedCollectionVisitStartCallback;
  final void Function(ClusterizedPlacemarkCollection) onClusterizedCollectionVisitEndCallback;

  @override
  void onPlacemarkVisited(PlacemarkMapObject placemark) => onPlacemarkVisitedCallback(placemark);

  @override
  void onPolylineVisited(PolylineMapObject polyline) => onPolylineVisitedCallback(polyline);

  @override
  void onPolygonVisited(PolygonMapObject polygon) => onPolygonVisitedCallback(polygon);

  @override
  void onCircleVisited(CircleMapObject circle) => onCircleVisitedCallback(circle);

  @override
  bool onCollectionVisitStart(MapObjectCollection collection) => onCollectionVisitStartCallback(collection);

  @override
  void onCollectionVisitEnd(MapObjectCollection collection) => onCollectionVisitEndCallback(collection);
